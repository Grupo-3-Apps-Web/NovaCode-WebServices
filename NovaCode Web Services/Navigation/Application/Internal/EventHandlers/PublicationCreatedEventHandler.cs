...
public class PublicationCreatedEventHandler : INotificationHandler<PublicationCreatedEvent>
{
    private readonly IVehicleRepository _vehicleRepository;

    public PublicationCreatedEventHandler(IVehicleRepository vehicleRepository)
    {
